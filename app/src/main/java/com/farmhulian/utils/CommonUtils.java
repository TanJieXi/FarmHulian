...
public class CommonUtils {
     ...
     * @param phoneNum 电话号码
     */
    public static void beginClickCallPhone(Context context,String phoneNum){
        Intent call_intent = new Intent();
        call_intent.setAction(Intent.ACTION_DIAL);
        Uri uri = Uri.parse("tel:".concat(phoneNum));
     ...
     * @param phoneNum  电话号码
     */
    public static void beginCallPhone(Context context,String phoneNum){
        Intent call_intent = new Intent();
    ...
    public static boolean appIsRunningForeground(Context context) {
        ...
        for (int i = 0; i < aps.size(); i++) {
            ...
            Log.i("appIsRunningForground ", String.valueOf(rap));
        }
        return false;
    }
    ...
    public static boolean isCorrectPassword(String str, boolean digitsAble) {
        return !TextUtils.isEmpty(str) && (!digitsAble || !TextUtils.isDigitsOnly(str)) && str.length() >= ContrantsF.PASSWORD_MIN_LEN && str.length() <= ContrantsF.PASSWORD_MAX_LEN;
    }
